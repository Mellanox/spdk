...
export CI_ENV_DOCA_RUNTIME_TAG="3.1.0-full-rt-ubuntu22.04-arm64"
export CI_ENV_DOCA_BUILDER_TAG="3.1.0-devel-ubuntu22.04-arm64"
...
# Format=<YYMMDD>-<ID>
export CI_ENV_CI_REV="3.1.0-250827-1"
