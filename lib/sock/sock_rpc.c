			  ...
			  const struct spdk_json_val *params)
{
	...
	spdk_json_write_named_bool(w, "enable_tcp_offload", sock_opts.enable_tcp_offload);
...
static const struct spdk_json_object_decoder rpc_sock_impl_set_opts_decoders[] = {
	...
	{
		"enable_tcp_offload", offsetof(struct spdk_rpc_sock_impl_set_opts, sock_opts.enable_tcp_offload),
		spdk_json_decode_bool, true
	}
};
